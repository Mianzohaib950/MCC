...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM `adminuser` where Email ='$email' AND Password = '$password' ";
        ...
        <div class="container">
            <div class="justify-content-center formbackground mx-auto pt-3 pb-5">
                <div class="selectuser my-4">
                    <div id="btn" class="right"></div>
                    <button type=button id="selectstudent" class="toggle-btn" onclick="leftClick()">Customer</span>
                    </button>
